...
!1;this._splitColors&&a.stack&&(0===a.stack[0]?a.custom_color="green":1===a.stack[0]&&(a.custom_color="blue"));var d=this._clones.getDrawEntryProperties(a);c=this._clones.createObject3D(a.stack,c,this.ctrl);d.material.wireframe=this.ctrl.wireframe;d.material.side=this.ctrl.bothSides?f.DoubleSide:f.FrontSide;b=-.9<c.matrixWorld.determinant()?new f.Mesh(b.geom,d.material):g.createFlippedMesh(b,d.material);c.add(b);b.stack=a.stack;b.renderOrder=this._clones.maxdepth-a.stack.length;b.$jsroot_order=c.$jsroot_depth;
if(this.ctrl._debug||this.ctrl._full)a=new f.WireframeGeometry(b.geometry),d=new f.LineBasicMaterial({color:d.fillcolor,linewidth:d.linewidth||1}),d=new f.LineSegments(a,d),c.add(d);if(this.ctrl._bound||this.ctrl._full)b=new f.BoxHelper(b),c.add(b);return!0};e.prototype.appendMoreNodes=function(a,b){if(this.drawing_stage&&!b)this._provided_more_nodes=a;else{if(this._more_nodes)for(var c=0;c<this._more_nodes.length;++c){var d=this._more_nodes[c],k=this._clones.createObject3D(d.stack,this._toplevel,
"delete_mesh");r.disposeThreejsObject(k);g.cleanupShape(d.server_shape);delete d.server_shape}delete this._more_nodes;if(a){c=[];for(d=0;d<a.length;++d){k=a[d];var h=k.server_shape;h&&h.ready&&(k.done=!0,h.used=!0,this.createEntryMesh(k,h,this._toplevel)&&c.push(k))}c&&(this._more_nodes=c);b||this.render3D()}}};e.prototype.getProjectionSource=function(){return this._clones_owner?this._full_geom:this._main_painter?this._main_painter._drawing_ready?this._main_painter._toplevel:(console.warn("MAIN PAINTER NOT READY WHEN DO PROJECTION"),
null):(console.warn("MAIN PAINTER DISAPPER"),null)};e.prototype.getGeomBoundingBox=function(a,b){var c=new f.Box3,d=!this._clones;if(!a)return c.min.x=c.min.y=c.min.z=-1,c.max.x=c.max.y=c.max.z=1,c;c.makeEmpty();a.traverse(function(a){(d||a.stack&&a instanceof f.Mesh||a.main_track&&a instanceof f.LineSegments)&&g.getBoundingBox(a,c)});void 0!==b&&c.expandByVector(c.getSize(new f.Vector3).multiplyScalar(b));return c};e.prototype.doProjection=function(){var a=this,b=this.getProjectionSource();if(!b)return!1;
r.disposeThreejsObject(this._toplevel,!0);if(void 0===this.ctrl.projectPos){var c=this.getGeomBoundingBox(b),d=c.min[this.ctrl.project];c=c.max[this.ctrl.project];var k=(d+c)/2;0>d&&0<c&&Math.abs(k)<.2*Math.max(-d,c)&&(k=0);this.ctrl.projectPos=k}b.traverse(function(b){if(b instanceof f.Mesh&&b.stack){var c=g.projectGeometry(b.geometry,b.parent.matrixWorld,a.ctrl.project,a.ctrl.projectPos,b._flippedMesh);c&&(c=new f.Mesh(c,b.material.clone()),a._toplevel.add(c),c.stack=b.stack)}});return!0};e.prototype.changedLight=
function(a){if(this._camera){var b=!a;a||(a=this.getGeomBoundingBox(this._toplevel));var c=a.max.x-a.min.x,d=a.max.y-a.min.y;a=a.max.z-a.min.z;var k=[],h=this.ctrl.light.power;void 0===h&&(h=1);if(this._camera._lights!=this.ctrl.light.kind)switch(r.disposeThreejsObject(this._camera,!0),this._camera._lights=this.ctrl.light.kind,this._camera._lights){case "ambient":this._camera.add(new f.AmbientLight(15724527,h));break;case "hemisphere":this._camera.add(new f.HemisphereLight(16777147,526368,h));break;
default:for(var e=0;6>e;++e)this._camera.add(new f.PointLight(15724527,h))}for(e=0;e<this._camera.children.length;++e){var g=this._camera.children[e],q=!1;if(g.isAmbientLight||g.isHemisphereLight)g.intensity=h;else if(g.isPointLight){switch(e){case 0:g.position.set(c/5,d/5,a/5);q=this.ctrl.light.specular;break;case 1:g.position.set(0,0,a/2);q=this.ctrl.light.front;break;case 2:g.position.set(0,2*d,0);q=this.ctrl.light.top;break;case 3:g.position.set(0,-2*d,0);q=this.ctrl.light.bottom;break;case 4:g.position.set(-2*
c,0,0);q=this.ctrl.light.left;break;case 5:g.position.set(2*c,0,0),q=this.ctrl.light.right}g.power=q?h*Math.PI*4:0;q&&k.push(g)}}k.forEach(function(a){a.power=4*h*Math.PI/k.length});b&&this.render3D()}};e.prototype.createScene=function(a,b){this._scene=new f.Scene;this._scene.fog=new f.Fog(16777215,1,1E4);this._scene.overrideMaterial=new f.MeshLambertMaterial({color:7340287,transparent:!0,opacity:.2,depthTest:!1});this._scene_width=a;this._scene_height=b;this.ctrl.ortho_camera?this._camera=new f.OrthographicCamera(-600,
600,-600,600,1,1E4):(this._camera=new f.PerspectiveCamera(25,a/b,1,1E4),this._camera.up=this.ctrl._yup?new f.Vector3(0,1,0):new f.Vector3(0,0,1));this._scene.add(this._camera);this._selected_mesh=null;this._overall_size=10;this._toplevel=new f.Object3D;this._scene.add(this._toplevel);this._renderer=r.createRender3D(a,b,this.options.Render3D,{antialias:!0,logarithmicDepthBuffer:!1,preserveDrawingBuffer:!0});this._webgl=this._renderer.jsroot_render3d===JSROOT.constants.Render3D.WebGL;this._renderer.setPixelRatio&&
...
0,0),0),new f.Plane(new f.Vector3(0,this.ctrl._yup?-1:1,0),0),new f.Plane(new f.Vector3(0,0,this.ctrl._yup?1:-1),0)];c=new f.PointLight(15724527,1);c.position.set(10,10,10);this._camera.add(c);this._webgl&&(this.ctrl.ssao.enabled||this.ctrl.outline)&&(this.ctrl.outline&&"function"==typeof this.createOutline?(this._effectComposer=new f.EffectComposer(this._renderer),this._effectComposer.addPass(new f.RenderPass(this._scene,this._camera)),this.createOutline(a,b)):this.ctrl.ssao.enabled&&this.createSSAO());
return this._fit_main_area&&!this._webgl?(c=JSROOT._.get_document().createElementNS("http://www.w3.org/2000/svg","svg"),p.select(c).attr("width",a).attr("height",b),c.appendChild(this._renderer.jsroot_dom),c):this._renderer.jsroot_dom};e.prototype.startDrawGeometry=function(a){a||0===this.drawing_stage?(this._clones_owner&&this._clones&&this._clones.setDefaultColors(this.ctrl.dflt_colors),this._last_render_tm=this._startm=(new Date).getTime(),this._last_render_meshes=0,this.drawing_stage=1,this._drawing_ready=
!1,this.drawing_log="collect visible",this.ctrl.info.num_meshes=0,this.ctrl.info.num_faces=0,this.ctrl.info.num_shapes=0,this._selected_mesh=null,this.ctrl.project&&(this._clones_owner?this._full_geom?(this.drawing_stage=10,this.drawing_log="build projection"):this._full_geom=new f.Object3D:(this.drawing_stage=9,this.drawing_log="wait for main painter")),delete this._last_manifest,delete this._last_hidden,delete this._draw_nodes_again,this.continueDraw()):this._draw_nodes_again=!0};e.prototype.resetAdvanced=
function(){this.ctrl.ssao.kernelRadius=16;this.ctrl.ssao.output=f.SSAOPass.OUTPUT.Default;this.ctrl.depthTest=!0;this.ctrl.clipIntersect=!0;this.ctrl.depthMethod="ray";this.changedDepthMethod("norender");this.changedDepthTest()};e.prototype.getOverallSize=function(a){if(!this._overall_size||a){a=this.getGeomBoundingBox(this._toplevel);if(isNaN(a.min.x))return 1E3;this._overall_size=2*Math.max(a.max.x-a.min.x,a.max.y-a.min.y,a.max.z-a.min.z)}return this._overall_size};e.prototype.createSnapshot=function(a){if(this._renderer){this.render3D(0);
var b=this._renderer.domElement.toDataURL("image/png");if("asis"===a)return b;b.replace("image/png","image/octet-stream");var c=JSROOT._.get_document(),d=c.createElement("a");"string"===typeof d.download&&(c.body.appendChild(d),d.download=a||"geometry.png",d.href=b,d.click(),c.body.removeChild(d))}};e.prototype.produceCameraUrl=function(a){if(this._lookat&&this._camera0pos&&this._camera&&this.ctrl){var b=(new f.Vector3).add(this._camera0pos).sub(this._lookat),c=(new f.Vector3).add(this._camera.position).sub(this._lookat),
d=b.length(),k=c.length();d=this.ctrl.zoom*k/d*100;1>d?d=1:1E4<d&&(d=1E4);b.normalize();c.normalize();k=new f.Quaternion;k.setFromUnitVectors(b,c);b=new f.Euler;b.setFromQuaternion(k,"YZX");c=b.y/Math.PI*180;b=b.z/Math.PI*180;0>c&&(c+=360);0>b&&(b+=360);return"roty"+c.toFixed(a||0)+",rotz"+b.toFixed(a||0)+",zoom"+d.toFixed(a||0)}};e.prototype.calculateZoom=function(){if(this._camera0pos&&this._camera&&this._lookat){var a=(new f.Vector3).add(this._camera0pos).sub(this._lookat);return(new f.Vector3).add(this._camera.position).sub(this._lookat).length()/
a.length()}return 0};e.prototype.adjustCameraPosition=function(a,b){if(this._toplevel){var c=this.getGeomBoundingBox(this._toplevel);if(!isNaN(c.min.x)){var d=c.max.x-c.min.x,k=c.max.y-c.min.y,h=c.max.z-c.min.z,e=(c.max.x+c.min.x)/2,g=(c.max.y+c.min.y)/2,q=(c.max.z+c.min.z)/2;this._overall_size=2*Math.max(d,k,h);this._camera.near=this._overall_size/350;this._camera.far=12*this._overall_size;this._scene.fog.near=2*this._overall_size;this._scene.fog.far=12*this._overall_size;if(a)for(a=0;3>a;++a){var l=
this.ctrl.clip[a];l.min=c.min[l.name];l.max=c.max[l.name];var u=l.max-l.min;l.max+=.01*u;l.min-=.01*u;l.value?l.value<l.min?l.value=l.min:l.value>l.max&&(l.value=l.max):l.value=(l.min+l.max)/2}this.ctrl.ortho_camera&&(this._camera.left=c.min.x,this._camera.right=c.max.x,this._camera.top=c.max.y,this._camera.bottom=c.min.y);this._camera.updateProjectionMatrix();a=2*this.ctrl.zoom;l=Math.max(d,k,h);if((this.ctrl.rotatey||this.ctrl.rotatez)&&this.ctrl.can_rotate)d=this.calculateZoom(),b&&d&&(a=2*d),
k=new f.Euler(0,this.ctrl.rotatey/180*Math.PI,this.ctrl.rotatez/180*Math.PI,"YZX"),this._camera.position.set(-a*l,0,0),this._camera.position.applyEuler(k),this._camera.position.add(new f.Vector3(e,g,q)),b&&d&&(b=this.calculateZoom(),this._camera.position.set(-(d/b*a)*l,0,0),this._camera.position.applyEuler(k),this._camera.position.add(new f.Vector3(e,g,q)));else if(this.ctrl.ortho_camera)this._camera.position.set(e,g,Math.max(d,k));else if(this.ctrl.project)switch(this.ctrl.project){case "x":this._camera.position.set(1.5*
a*Math.max(k,h),0,0);break;case "y":this._camera.position.set(0,1.5*a*Math.max(d,h),0);break;case "z":this._camera.position.set(0,0,1.5*a*Math.max(d,k))}else this.ctrl._yup?this._camera.position.set(e-a*Math.max(d,h),g+a*k,q-a*Math.max(d,h)):this._camera.position.set(e-a*Math.max(d,k),g-a*Math.max(d,k),q+a*h);this._lookat=new f.Vector3(e,g,q);this._camera0pos=new f.Vector3(-2*l,0,0);this._camera.lookAt(this._lookat);this.changedLight(c);this._controls&&(this._controls.target.copy(this._lookat),this._controls.update());
this.ctrl.select_in_view&&this.startDrawGeometry()}}};e.prototype.setCameraPosition=function(a,b,c){this.ctrl&&(this.ctrl.rotatey=a||0,this.ctrl.rotatez=b||0,a=!1,c&&!isNaN(c)?this.ctrl.zoom=c:a=!0,this.adjustCameraPosition(!1,a))};e.prototype.focusOnItem=function(a){a&&this._clones&&(a=this._clones.findStackByName(a))&&(a=this._clones.resolveStack(a,!0),this.focusCamera(a,!1))};e.prototype.focusCamera=function(a,b){var c=this;if(this.ctrl.project||this.ctrl.ortho_camera)return this.adjustCameraPosition();
var d=new f.Box3;if(void 0===a)d=this.getGeomBoundingBox(this._toplevel);else if(a instanceof f.Mesh)d.setFromObject(a);else{var k=(new f.Vector3).setFromMatrixPosition(a.matrix);a=a.node;a=(new f.Vector3(a.fDX,a.fDY,a.fDZ)).multiplyScalar(.5);d.min=k.clone().sub(a);d.max=k.clone().add(a)}var h=d.max.x-d.min.x,e=d.max.y-d.min.y,g=d.max.z-d.min.z;k=(d.max.x+d.min.x)/2;a=(d.max.y+d.min.y)/2;d=(d.max.z+d.min.z)/2;h=this.ctrl._yup?new f.Vector3(k-2*Math.max(h,g),a+2*e,d-2*Math.max(h,g)):new f.Vector3(k-
2*Math.max(h,e),a-2*Math.max(h,e),d+2*g);d=new f.Vector3(k,a,d);var q=this._controls.target,l=50,u=0,r=h.sub(this._camera.position).divideScalar(l),p=d.sub(q).divideScalar(l);if(b=b&&this._webgl){for(d=0;3>d;++d)k=this.ctrl.clip[d],k.enabled||(k.value=k.min,k.enabled=!0),k.inc=((k.min+k.max)/2-k.value)/l;this.updateClipping()}this._animating=!0;var m=function(){if(void 0!==c._animating){c._animating?requestAnimationFrame(m):c._geom_viewer||c.startDrawGeometry();var a=-Math.cos(2*Math.PI*u/l)+1;c._camera.position.add(r.clone().multiplyScalar(a));
q.add(p.clone().multiplyScalar(a));c._lookat=q;c._camera.lookAt(c._lookat);c._camera.updateProjectionMatrix();var d=(new Date).getTime();if(b){for(var h=0;3>h;++h)c.ctrl.clip[h].value+=c.ctrl.clip[h].inc*a;c.updateClipping()}else c.render3D(0);a=(new Date).getTime();0==u&&200<a-d&&(l=20);u++;c._animating=u<l}};m()};e.prototype.autorotate=function(a){var b=this,c=void 0===a?2:a,d=new Date,k=function(){if(b._renderer&&b.ctrl){var a=new Date;b.ctrl.rotate&&requestAnimationFrame(k);b._controls&&(b._controls.autoRotate=
b.ctrl.rotate,b._controls.autoRotateSpeed=c*(a.getTime()-d.getTime())/16.6666,b._controls.update());d=new Date;b.render3D(0)}};this._webgl&&k()};e.prototype.completeScene=function(){if(this.ctrl._debug||this.ctrl._grid){if(this.ctrl._full){var a=new f.BoxHelper(this._toplevel);this._scene.add(a)}this._scene.add(new f.AxesHelper(2*this._overall_size));this._scene.add(new f.GridHelper(Math.ceil(this._overall_size),Math.ceil(this._overall_size)/50));this.helpText("<font face='verdana' size='1' color='red'><center>Transform Controls<br>'T' translate | 'R' rotate | 'S' scale<br>'+' increase size | '-' decrease size<br>'W' toggle wireframe/solid display<br>keep 'Ctrl' down to snap to grid</center></font>")}};
e.prototype.drawCount=function(a,b){function c(a){return JSROOT.batch_mode?"anytime ms":a.toString()+" ms"}var d=this,k=["Unique nodes: "+this._clones.nodes.length,"Unique visible: "+a,"Time to clone: "+c(b)];this._clones.scanVisible();var h=0,e={clones:this._clones,cnt:[],func:function(a){void 0===this.cnt[this.last]?this.cnt[this.last]=1:this.cnt[this.last]++;h+=g.countNumShapes(this.clones.getNodeShape(a.id));return!0}},f=(new Date).getTime(),q=this._clones.scanVisible(e),l=(new Date).getTime();
k.push("Total visible nodes: "+q,"Total shapes: "+h);for(a=0;a<e.cnt.length;++a)void 0!==e.cnt[a]&&k.push("  lvl"+a+": "+e.cnt[a]);k.push("Time to scan: "+c(l-f),"","Check timing for matrix calculations ...");var u=this.selectDom().style("overflow","auto");JSROOT.batch_mode?u.property("_json_object_",k):k.forEach(function(a){return u.append("p").text(a)});return new Promise(function(a){setTimeout(function(){e.domatrix=!0;f=(new Date).getTime();q=d._clones.scanVisible(e);l=(new Date).getTime();var b=
"Time to scan with matrix: "+c(l-f);JSROOT.batch_mode?k.push(b):u.append("p").text(b);a(d)},100)})};e.prototype.performDrop=function(a,b,c,d){var k=this;if(a&&"TTree"===a.$kind)return b="extract_geo_tracks",d&&0<d.indexOf("$")&&(b=d.substr(0,d.indexOf("$")),d=d.substr(d.indexOf("$")+1)),(c=JSROOT.findFunction(b))?c(a,d).then(function(a){a&&(k.drawExtras(a,"",!1),k.updateClipping(!0),k.render3D(100));return k}):Promise.reject(Error("Function "+b+" not found"));this.drawExtras(a,b)&&(c&&(c._painter=
this),this.render3D(100));return Promise.resolve(this)};e.prototype.mouseOverHierarchy=function(a,b,c){this.ctrl&&(c=c._obj,this.ctrl._debug&&console.log("Mouse over",a,b,c?c._typename:"---"),!c||"TEveTrack"!==c._typename&&"TEvePointSet"!==c._typename&&"TPolyMarker3D"!==c._typename||this.highlightMesh(null,65280,a?c:null))};e.prototype.clearExtras=function(){this.getExtrasContainer("delete");delete this._extraObjects;this.render3D()};e.prototype.addExtra=function(a,b){void 0===this._extraObjects&&
(this._extraObjects=JSROOT.create("TList"));if(0<=this._extraObjects.arr.indexOf(a))return!1;this._extraObjects.Add(a,b);delete a.$hidden_via_menu;return!0};e.prototype.extraObjectVisible=function(a,b,c){if(this._extraObjects){a=a.itemFullName(b);var d=this._extraObjects.opt.indexOf(a);0>d&&b._obj&&(d=this._extraObjects.arr.indexOf(b._obj),0<=d&&(this._extraObjects.opt[d]=a));if(!(0>d)){var k=this._extraObjects.arr[d];b=k.$hidden_via_menu?!1:!0;if(c){k.$hidden_via_menu=b;b=!b;var h=null;this._toplevel.traverse(function(a){a.geo_object===
k&&(h=a)});h?h.visible=b:b&&(this.drawExtras(k,"",!1),this.updateClipping(!0));(h||b)&&this.render3D()}return b}}};e.prototype.drawExtras=function(a,b,c){if(!a||!a._typename||!c&&a.$hidden_via_menu)return!1;var d=!1,k=!1;void 0===c&&(k=c=!0);if("TList"===a._typename||"TObjArray"===a._typename){if(!a.arr)return!1;for(var h=0;h<a.arr.length;++h){var e=a.arr[h],f=a.opt?a.opt[h]:"";f||(f=(b||"<prnt>")+"/["+h+"]");this.drawExtras(e,f,c)&&(d=!0)}}else if("THREE.Mesh"===a._typename)this.addToExtrasContainer(a),
d=!0;else if("TGeoTrack"===a._typename){if(c&&!this.addExtra(a,b))return!1;d=this.drawGeoTrack(a,b)}else if("TEveTrack"===a._typename||"ROOT::Experimental::TEveTrack"===a._typename){if(c&&!this.addExtra(a,b))return!1;d=this.drawEveTrack(a,b)}else if("TEvePointSet"===a._typename||"ROOT::Experimental::TEvePointSet"===a._typename||"TPolyMarker3D"===a._typename){if(c&&!this.addExtra(a,b))return!1;d=this.drawHit(a,b)}else if("TEveGeoShapeExtract"===a._typename||"ROOT::Experimental::REveGeoShapeExtract"===
a._typename){if(c&&!this.addExtra(a,b))return!1;d=this.drawExtraShape(a,b)}k&&d&&(this.updateClipping(!0),this.render3D(100));return d};e.prototype.getExtrasContainer=function(a,b){if(!this._toplevel)return null;b||(b="tracks");for(var c=null,d=[],k=0;k<this._toplevel.children.length;++k){var h=this._toplevel.children[k];if(h._extras)if("collect"===a)d.push(h);else if(h._extras===b){c=h;break}}if("collect"===a){for(a=0;a<d.length;++a)this._toplevel.remove(d[a]);return d}if("delete"===a)return c&&
this._toplevel.remove(c),r.disposeThreejsObject(c),null;"get"===a||c||(c=new f.Object3D,c._extras=b,this._toplevel.add(c));return c};e.prototype.addToExtrasContainer=function(a,b){(b=this.getExtrasContainer("",b))?b.add(a):(console.warn("Fail to add object to extras"),r.disposeThreejsObject(a))};e.prototype.drawGeoTrack=function(a,b){if(!a||!a.fNpoints)return!1;var c=a.fLineWidth||1,d=r.getColor(a.fLineColor)||"rgb(255,0,255)";JSROOT.browser.isWin&&(c=1);for(var k=Math.round(a.fNpoints/4),h=new Float32Array(6*
(k-1)),e=0,g=this.ctrl.projectPos,q="x"===this.ctrl.project,l="y"===this.ctrl.project,u="z"===this.ctrl.project,p=0;p<k-1;++p)h[e]=q?g:a.fPoints[4*p],h[e+1]=l?g:a.fPoints[4*p+1],h[e+2]=u?g:a.fPoints[4*p+2],h[e+3]=q?g:a.fPoints[4*p+4],h[e+4]=l?g:a.fPoints[4*p+5],h[e+5]=u?g:a.fPoints[4*p+6],e+=6;c=new f.LineBasicMaterial({color:d,linewidth:c});h=r.createLineSegments(h,c);h.renderOrder=1E6;h.geo_name=b;h.geo_object=a;h.hightlightWidthScale=2;b&&0==b.indexOf("<prnt>/Tracks")&&(h.main_track=!0);this.addToExtrasContainer(h);
return!0};e.prototype.drawEveTrack=function(a,b){if(!a||0>=a.fN)return!1;var c=a.fLineWidth||1,d=r.getColor(a.fLineColor)||"rgb(255,0,255)";JSROOT.browser.isWin&&(c=1);for(var e=new Float32Array(6*(a.fN-1)),h=0,g=this.ctrl.projectPos,t="x"===this.ctrl.project,q="y"===this.ctrl.project,l="z"===this.ctrl.project,u=0;u<a.fN-1;++u)e[h]=t?g:a.fP[3*u],e[h+1]=q?g:a.fP[3*u+1],e[h+2]=l?g:a.fP[3*u+2],e[h+3]=t?g:a.fP[3*u+3],e[h+4]=q?g:a.fP[3*u+4],e[h+5]=l?g:a.fP[3*u+5],h+=6;c=new f.LineBasicMaterial({color:d,
linewidth:c});e=r.createLineSegments(e,c);e.renderOrder=1E6;e.geo_name=b;e.geo_object=a;e.hightlightWidthScale=2;this.addToExtrasContainer(e);return!0};e.prototype.drawHit=function(a,b){if(!a||!a.fN||0>a.fN)return!1;var c=a.fMarkerSize*this.getOverallSize()*.005;.2>=c&&(c=.2);var d=a.fMarkerStyle;if(4==d||2==d)d=7,c*=1.5;var e=a.fN,h=this.ctrl.projectPos,f="x"===this.ctrl.project,g="y"===this.ctrl.project,q="z"===this.ctrl.project;c=new r.PointsCreator(e,this._webgl,c);for(var l=0;l<e;l++)c.addPoint(f?
h:a.fP[3*l],g?h:a.fP[3*l+1],q?h:a.fP[3*l+2]);d=c.createPoints({color:r.getColor(a.fMarkerColor)||"rgb(0,0,255)",style:d});d.renderOrder=1E6;d.highlightScale=2;d.geo_name=b;d.geo_object=a;this.addToExtrasContainer(d);return!0};e.prototype.drawExtraShape=function(a,b){var c=g.build(a);if(!c)return!1;c.geo_name=b;c.geo_object=a;this.addToExtrasContainer(c);return!0};e.prototype.findNodeWithVolume=function(a,b,c,d,e){var h=!1,f=null;if(c)0<d.length&&(d+="/"),d+=c.fName;else{c=this.getGeometry();if(!c&&
0!==g.getNodeKind(c))return null;d=this.geo_manager?c.fName:"";h=!0;e=[]}if(!c.fVolume||c.fVolume._searched)return null;if(a.test(c.fVolume.fName)&&(f=b({node:c,item:d})))return f;c.fVolume._searched=!0;e.push(c.fVolume);if(c.fVolume.fNodes)for(var k=0;k<c.fVolume.fNodes.arr.length&&!(f=this.findNodeWithVolume(a,b,c.fVolume.fNodes.arr[k],d,e));++k);if(h)for(a=0,b=e.length;a<b;++a)delete e[a]._searched;return f};e.prototype.loadMacro=function(a){var b={obj:this.getGeometry(),prefix:""};this.geo_manager&&
(b.prefix=b.obj.fName);if(!a||3>a.length||0!==g.getNodeKind(b.obj))return Promise.resolve(b);var c=this,d={GetVolume:function(a){var d=c.findNodeWithVolume(new RegExp("^"+a+"$"),function(a){return a});d||console.log("Did not found "+a+" volume");return{found:d,fVolume:d?d.node.fVolume:null,InvisibleAll:function(a){g.setInvisibleAll(this.fVolume,a)},Draw:function(){this.found&&this.fVolume&&(b.obj=this.found.node,b.prefix=this.found.item,console.log("Select volume for drawing",this.fVolume.fName,b.prefix))},
SetTransparency:function(a){this.fVolume&&this.fVolume.fMedium&&this.fVolume.fMedium.fMaterial&&(this.fVolume.fMedium.fMaterial.fFillStyle=3E3+a)},SetLineColor:function(a){this.fVolume&&(this.fVolume.fLineColor=a)}}},DefaultColors:function(){c.ctrl.dflt_colors=!0},SetMaxVisNodes:function(a){c.ctrl.maxnodes||(c.ctrl.maxnodes=pasrseInt(a)||0)},SetVisLevel:function(a){c.ctrl.vislevel||(c.ctrl.vislevel=parseInt(a)||0)}};r.showProgress("Loading macro "+a);return JSROOT.httpRequest(a,"text").then(function(a){a=
a.split("\n");for(var c=0;c<a.length;){var e=a[c++].trim();if(!(0==e.indexOf("//")||0>e.indexOf("gGeoManager")||(e=e.replace("->GetVolume",".GetVolume"),e=e.replace("->InvisibleAll",".InvisibleAll"),e=e.replace("->SetMaxVisNodes",".SetMaxVisNodes"),e=e.replace("->DefaultColors",".DefaultColors"),e=e.replace("->Draw",".Draw"),e=e.replace("->SetTransparency",".SetTransparency"),e=e.replace("->SetLineColor",".SetLineColor"),e=e.replace("->SetVisLevel",".SetVisLevel"),0<=e.indexOf("->"))))try{(new Function("gGeoManager",
e))(d)}catch(t){console.error("Problem by processing "+e)}}return b}).catch(function(){console.error("Fail to load "+a);return b})};e.prototype.assignClones=function(a){this._clones_owner=!0;this._clones=a};e.prototype.prepareObjectDraw=function(a,b){var c=this;if(this.did_cleanup)return Promise.resolve(null);if("__geom_viewer_append__"==b)this._new_append_nodes=a,this.ctrl.use_worker=0,this._geom_viewer=!0;else if("__geom_viewer_selection__"==b&&this._clones)this._new_draw_nodes=a,this.ctrl.use_worker=
0,this._geom_viewer=!0;else if(this._main_painter)this._clones_owner=!1,this._clones=this._main_painter._clones,console.log("Reuse clones",this._clones.nodes.length,"from main painter");else if(a){this._start_drawing_time=(new Date).getTime();this._clones_owner=!0;this._clones=new g.ClonedNodes(a);a=this.ctrl.vislevel;var d=this.ctrl.maxnodes;this.geo_manager&&(!a&&this.geo_manager.fVisLevel&&(a=this.geo_manager.fVisLevel),d||(d=this.geo_manager.fMaxVisNodes));this._clones.setVisLevel(a);this._clones.setMaxVisNodes(d);
this._clones.name_prefix=b;a=!!this.geo_manager&&!this.ctrl.showtop;b=this.ctrl.no_screen?0:this._clones.markVisibles(!0,!1,a);b=0>=b?this._clones.markVisibles(!1,!1,a):this._clones.markVisibles(!0,!0,a);this._clones.produceIdShifts();a=(new Date).getTime()-this._start_drawing_time;this._scene||console.log("Creating clones",this._clones.nodes.length,"takes",a,"uniquevis",b);if(this.options._count)return this.drawCount(b,a)}else this._clones_owner=!1,this._clones=null;this._scene||(this.ctrl.maxlimit=
(this._webgl?2E5:1E5)*this.ctrl.more,this._first_drawing=!0,0<this.ctrl.use_worker&&this.startWorker(),r.assign3DHandler(this),b=this.getSizeFor3d(this._webgl?void 0:3),this._fit_main_area=-1===b.can3d,a=this.createScene(b.width,b.height),this.add3dCanvas(b,a,this._webgl),this.setAsMainPainter());this.createToolbar();if(this._clones)return new Promise(function(a){c._resolveFunc=a;c.showDrawInfo("Drawing geometry");c.startDrawGeometry(!0)});this.completeDraw();return Promise.resolve(this)};e.prototype.showDrawInfo=
function(a){if(this._first_drawing&&this._start_drawing_time){var b=this._renderer.domElement.parentNode,c=p.select(b).select(".geo_info");if(a){var d=.001*((new Date).getTime()-this._start_drawing_time);c.empty()&&(c=p.select(b).append("p").attr("class","geo_info"));c.html(a+", "+d.toFixed(1)+"s")}else c.remove()}};e.prototype.continueDraw=function(){if(0!==this.drawing_stage){for(var a=(new Date).getTime(),b=this._first_drawing?1E3:200,c=a;;){var d=this.nextDrawAction();if(!d)break;c=(new Date).getTime();
if(1E5<c-this._startm){this.drawing_stage=0;break}if(!(!0===d&&c-a<b)&&(c-a>b||1===d||2===d)){r.showProgress(this.drawing_log);this.showDrawInfo(this.drawing_log);this._first_drawing&&this._webgl&&100<this._num_meshes-this._last_render_meshes&&c-this._last_render_tm>2.5*b&&(this.adjustCameraPosition(),this.render3D(-1),this._last_render_meshes=this.ctrl.info.num_meshes);2!==d&&setTimeout(this.continueDraw.bind(this),1===d?100:1);return}}a=c-this._startm;this._first_drawing&&console.log("Create tm = "+
a+" meshes "+this.ctrl.info.num_meshes+" faces "+this.ctrl.info.num_faces);if(300<a)return r.showProgress("Rendering geometry"),this.showDrawInfo("Rendering"),setTimeout(this.completeDraw.bind(this,!0),10);this.completeDraw(!0)}};e.prototype.testCameraPosition=function(a){this._camera.updateMatrixWorld();var b=this._camera.position.clone();!a&&this._last_camera_position&&this._last_camera_position.distanceTo(b)<1E-4*(this._overall_size||1E3)||(this._last_camera_position=b,!this.ctrl.project&&this._webgl&&
g.produceRenderOrder(this._toplevel,b,this.ctrl.depthMethod,this._clones))};e.prototype.render3D=function(a,b){var c=this;if(this._renderer)if(void 0===a&&(a=5),0<a&&this._webgl&&!JSROOT.batch_mode)this.render_tmout||(this.render_tmout=setTimeout(function(){return c.render3D(0,b)},a));else{this.render_tmout&&(clearTimeout(this.render_tmout),delete this.render_tmout);r.beforeRender3D(this._renderer);var d=new Date;this.testCameraPosition(-1===a);this._webgl&&this._effectComposer&&0<this._effectComposer.passes.length?
this._effectComposer.render():this._renderer.render(this._scene,this._camera);a=new Date;this.last_render_tm=a.getTime();0===this.first_render_tm&&b&&(this.first_render_tm=a.getTime()-d.getTime(),console.log("three.js r"+f.REVISION+", first render tm = "+this.first_render_tm));return r.afterRender3D(this._renderer)}else console.warn("renderer object not exists - check code")};e.prototype.startWorker=function(){if(!this._worker){this._worker_ready=!1;this._worker_jobs=0;var a=this;this._worker=new Worker(JSROOT.source_dir+
"scripts/JSRoot.geoworker.js");this._worker.onmessage=function(b){if("object"===typeof b.data){if("log"in b.data)return console.log("geo: "+b.data.log);if("progress"in b.data)return r.showProgress(b.data.progress);b.data.tm3=(new Date).getTime();"init"in b.data?(a._worker_ready=!0,console.log("Worker ready: "+(b.data.tm3-b.data.tm0))):a.processWorkerReply(b.data)}};this._worker.postMessage({init:!0,browser:JSROOT.browser,tm0:(new Date).getTime(),vislevel:this._clones.getVisLevel(),maxvisnodes:this._clones.getMaxVisNodes(),
clones:this._clones.nodes,sortmap:this._clones.sortmap})}};e.prototype.canSubmitToWorker=function(a){return this._worker?this._worker_ready&&(0==this._worker_jobs||a):!1};e.prototype.submitToWorker=function(a){if(!this._worker)return!1;this._worker_jobs++;a.tm0=(new Date).getTime();this._worker.postMessage(a)};e.prototype.processWorkerReply=function(a){this._worker_jobs--;if("collect"in a)return this._new_draw_nodes=a.new_nodes,this._draw_all_nodes=a.complete,this.drawing_stage=3,this.continueDraw();
if("shapes"in a){for(var b=0;b<a.shapes.length;++b){var c=a.shapes[b],d=this._build_shapes[b];c.buf_pos&&c.buf_norm&&(0===c.buf_pos.length?d.geom=null:c.buf_pos.length!==c.buf_norm.length?(console.error("item.buf_pos",c.buf_pos.length,"item.buf_norm",c.buf_norm.length),d.geom=null):(d.geom=new f.BufferGeometry,d.geom.setAttribute("position",new f.BufferAttribute(c.buf_pos,3)),d.geom.setAttribute("normal",new f.BufferAttribute(c.buf_norm,3))),d.ready=!0,d.nfaces=c.nfaces)}a.tm4=(new Date).getTime();
this.drawing_stage=7;return this.continueDraw()}};e.prototype.testGeomChanges=function(){if(this._main_painter)return console.warn("Get testGeomChanges call for slave painter"),this._main_painter.testGeomChanges();this.startDrawGeometry();for(var a=0;a<this._slave_painters.length;++a)this._slave_painters[a].startDrawGeometry()};e.prototype.drawSimpleAxis=function(a){this.getExtrasContainer("delete","axis");if(!this.ctrl._axis)return a?null:this.render3D();var b=this.getGeomBoundingBox(this._toplevel),
c=this.getExtrasContainer("create","axis"),d=.02*Math.max(b.max.x-b.min.x,b.max.y-b.min.y,b.max.z-b.min.z),e=[0,0,0],h=["x","y","z"],g=["X","Y","Z"],t=["red","green","blue"],q=this.ctrl.ortho_camera,l=[this.ctrl._yup,this.ctrl._yup,this.ctrl._yup],u=3;if(2==this.ctrl._axis)for(var p=0;3>p;++p){var m=h[p];0>=b.min[m]&&0<=b.max[m]||(e[p]=(b.min[m]+b.max[m])/2)}this.ctrl.ortho_camera&&(u=2,g[0]=g[2],t[0]=t[2],l[0]=l[2],q=!0);p={};for(m=0;m<u;p={$jscomp$loop$prop$name$13$18:p.$jscomp$loop$prop$name$13$18},
++m){var x=function(a){return function(c){return 2>b.max[a.$jscomp$loop$prop$name$13$18]-b.min[a.$jscomp$loop$prop$name$13$18]?c.toFixed(3):1E5<Math.abs(c)?c.toExponential(3):Math.round(c).toString()}}(p),w=new Float32Array(6),y=t[m];p.$jscomp$loop$prop$name$13$18=h[m];var v=x(b.max[p.$jscomp$loop$prop$name$13$18]);w[0]=b.min.x;w[1]=b.min.y;w[2]=b.min.z;w[3]=b.min.x;w[4]=b.min.y;w[5]=b.min.z;switch(m){case 0:w[3]=b.max.x;v=l[0]&&!q?g[0]+" "+v:v+(" "+g[0]);break;case 1:w[4]=b.max.y;v=l[1]?v+(" "+g[1]):
g[1]+" "+v;break;case 2:w[5]=b.max.z,v+=" "+g[2]}if(2==this.ctrl._axis)for(var n=0;6>n;++n)n%3!==m&&(w[n]=e[n%3]);n=new f.LineBasicMaterial({color:y});n=r.createLineSegments(w,n);c.add(n);y=new f.MeshBasicMaterial({color:y});0===e[m]&&e[m]>=b.min[p.$jscomp$loop$prop$name$13$18]&&e[m]<=b.max[p.$jscomp$loop$prop$name$13$18]&&(2!=this.ctrl._axis||0===m)&&(n=q?new f.CircleBufferGeometry(.25*d):new f.SphereBufferGeometry(.25*d),n=new f.Mesh(n,y),n.translateX(0===m?e[0]:w[0]),n.translateY(1===m?e[1]:w[1]),
n.translateZ(2===m?e[2]:w[2]),c.add(n));v=new f.TextGeometry(v,{font:JSROOT.threejs_font_helvetiker_regular,size:d,height:0,curveSegments:5});n=new f.Mesh(v,y);v=(new f.Box3).setFromObject(n);n.translateX(w[3]);n.translateY(w[4]);n.translateZ(w[5]);if(l[m])switch(m){case 0:q?n.translateX(.5*d):(n.rotateY(Math.PI),n.translateX(-v.max.x-.5*d));n.translateY(-v.max.y/2);break;case 1:q?n.rotateZ(Math.PI/2):(n.rotateX(-Math.PI/2),n.rotateY(-Math.PI/2));n.translateX(.5*d);n.translateY(-v.max.y/2);break;
case 2:n.rotateY(-Math.PI/2),n.translateX(.5*d),n.translateY(-v.max.y/2)}else switch(m){case 0:n.rotateX(Math.PI/2);n.translateY(-v.max.y/2);n.translateX(.5*d);break;case 1:n.rotateX(Math.PI/2);n.rotateY(-Math.PI/2);n.translateX(-v.max.x-.5*d);n.translateY(-v.max.y/2);break;case 2:n.rotateX(Math.PI/2),n.rotateZ(Math.PI/2),n.translateX(.5*d),n.translateY(-v.max.y/2)}c.add(n);v=new f.TextGeometry(x(b.min[p.$jscomp$loop$prop$name$13$18]),{font:JSROOT.threejs_font_helvetiker_regular,size:d,height:0,curveSegments:5});
n=new f.Mesh(v,y);v=(new f.Box3).setFromObject(n);n.translateX(w[0]);n.translateY(w[1]);n.translateZ(w[2]);if(l[m])switch(m){case 0:q?n.translateX(-v.max.x-.5*d):(n.rotateY(Math.PI),n.translateX(.5*d));n.translateY(-v.max.y/2);break;case 1:q?n.rotateZ(Math.PI/2):(n.rotateX(-Math.PI/2),n.rotateY(-Math.PI/2));n.translateY(-v.max.y/2);n.translateX(-v.max.x-.5*d);break;case 2:n.rotateY(-Math.PI/2),n.translateX(-v.max.x-.5*d),n.translateY(-v.max.y/2)}else switch(m){case 0:n.rotateX(Math.PI/2);n.translateX(-v.max.x-
.5*d);n.translateY(-v.max.y/2);break;case 1:n.rotateX(Math.PI/2);n.rotateY(-Math.PI/2);n.translateY(-v.max.y/2);n.translateX(.5*d);break;case 2:n.rotateX(Math.PI/2),n.rotateZ(Math.PI/2),n.translateX(-v.max.x-.5*d),n.translateY(-v.max.y/2)}c.add(n)}this.changedDepthMethod(a?"norender":void 0)};e.prototype.toggleAxesDraw=function(){this.setAxesDraw("toggle")};e.prototype.setAxesDraw=function(a){this.ctrl._axis="toggle"===a?this.ctrl._axis?0:1:"number"==typeof a?a:a?1:0;this.drawSimpleAxis()};e.prototype.setAutoRotate=
function(a){this.ctrl.project||(void 0!==a&&(this.ctrl.rotate=a),this.autorotate(2.5))};e.prototype.toggleWireFrame=function(){this.ctrl.wireframe=!this.ctrl.wireframe;this.changedWireFrame()};e.prototype.setWireFrame=function(a){this.ctrl.wireframe=a?!0:!1;this.changedWireFrame()};e.prototype.setShowTop=function(a){this.ctrl.showtop=a?!0:!1;this.redrawObject("same")};e.prototype.changedClipping=function(a){var b=this.ctrl.clip;if(!(void 0!==a&&0<=a)||b[a].enabled){if(b[0].enabled||b[1].enabled||
b[2].enabled)this.ctrl.ssao.enabled=!1,this.removeSSAO();this.updateClipping(!1,!0)}};e.prototype.changedDepthTest=function(){if(this._toplevel){var a=this.ctrl.depthTest;this._toplevel.traverse(function(b){b instanceof f.Mesh&&(b.material.depthTest=a)});this.render3D(0)}};e.prototype.changedDepthMethod=function(a){delete this._last_camera_position;"norender"!==a&&this.render3D()};e.prototype.changedHighlight=function(){this.ctrl.highlight||this.highlightMesh(null)};e.prototype.updateClipping=function(a,
b){if(this._webgl){for(var c=this.ctrl.clip,d=[],e=!1,h=[c[0].value,-1*c[1].value,(this.ctrl._yup?-1:1)*c[2].value],g=this.ctrl.clipIntersect?16:0,t=0;3>t;++t)c[t].enabled&&(g+=2<<t),this._clipPlanes[t].constant!=h[t]&&(e=!0,this._clipPlanes[t].constant=h[t]);this.ctrl.ssao.enabled||(c[0].enabled&&d.push(this._clipPlanes[0]),c[1].enabled&&d.push(this._clipPlanes[1]),c[2].enabled&&d.push(this._clipPlanes[2]),g+=1E3*d.length);0==d.length&&(d=null);this._clipCfg!==g&&(e=!0);this._clipCfg=g;c=!!d;var q=
this.ctrl.clipIntersect,l=c?f.DoubleSide:f.FrontSide;(b||e)&&this._scene.traverse(function(a){a.hasOwnProperty("material")&&a.material&&void 0!==a.material.clippingPlanes&&(a.material.clippingPlanes!==d&&(a.material.clipIntersection=q,a.material.clippingPlanes=d,a.material.needsUpdate=!0),void 0!==a.material.emissive&&a.material.side!=l&&(a.material.side=l,a.material.needsUpdate=!0))});this.ctrl.bothSides=c;a||this.render3D(0);return e}};e.prototype.setCompleteHandler=function(a){this._complete_handler=
a};e.prototype.completeDraw=function(a){var b=!1,c=!1,d=!0;if(this.ctrl){this._clones?(this._first_drawing||this._full_redrawing)&&this.ctrl.tracks&&this.geo_manager&&this.drawExtras(this.geo_manager.fTracks,"<prnt>/Tracks"):(d=!1,this.getExtrasContainer("delete"),this.drawExtras((this._main_painter?this._main_painter._extraObjects:null)||this._extraObjects,"",!1));this._full_redrawing&&(this._full_redrawing=!1,c=!0,this.changedDepthMethod("norender"));this._first_drawing&&(this.adjustCameraPosition(!0),
this.showDrawInfo(),this._first_drawing=!1,c=b=!0);0!==this.ctrl.transparency&&this.changedGlobalTransparency(this.ctrl.transparency,!0);b&&this.completeScene();c&&(this.ctrl.trans_radial||this.ctrl.trans_z)&&this.changedTransformation("norender");c&&this.ctrl._axis&&this.drawSimpleAxis(!0);this._scene.overrideMaterial=null;void 0!==this._provided_more_nodes&&(this.appendMoreNodes(this._provided_more_nodes,!0),delete this._provided_more_nodes);d&&(this.getExtrasContainer("delete"),this.drawExtras((this._main_painter?
this._main_painter._extraObjects:null)||this._extraObjects,"",!1));this.updateClipping(!0);this.render3D(0,!0);a&&r.showProgress();this.addOrbitControls();this.addTransformControl();b&&(!1===this.ctrl.highlight&&(this.ctrl.highlight=1E3>this.first_render_tm),!1===this.ctrl.highlight_scene&&(this.ctrl.highlight_scene=this.ctrl.highlight),this._webgl&&this.ctrl.rotate&&!this.ctrl.project&&this.autorotate(2.5),this._webgl&&this.ctrl.show_controls&&!JSROOT.batch_mode&&this.showControlOptions(!0));this.setAsMainPainter();
"function"==typeof this._resolveFunc&&(this._resolveFunc(this),delete this._resolveFunc);"function"==typeof this._complete_handler&&this._complete_handler(this);if(this._draw_nodes_again)return this.startDrawGeometry();this._drawing_ready=!0}else console.warn("ctrl object does not exist in completeDraw - something went wrong")};e.prototype.isDrawingReady=function(){return this._drawing_ready||!1};e.prototype.removeDrawnNode=function(a){if(this._draw_nodes){for(var b=[],c=0;c<this._draw_nodes.length;++c){var d=
this._draw_nodes[c];d.nodeid===a||this._clones.isIdInStack(a,d.stack)?this._clones.createObject3D(d.stack,this._toplevel,"delete_mesh"):b.push(d)}b.length<this._draw_nodes.length&&(this._draw_nodes=b,this.render3D())}};e.prototype.cleanup=function(a){if(!a){this.removeSSAO();this.clearTopPainter();a=this.clear3dCanvas();this._toolbar&&this._toolbar.cleanup();this.helpText();r.disposeThreejsObject(this._scene);r.disposeThreejsObject(this._full_geom);this._tcontrols&&this._tcontrols.dispose();this._controls&&
this._controls.cleanup();this._context_menu&&this._renderer.domElement.removeEventListener("contextmenu",this._context_menu,!1);this._datgui&&this._datgui.destroy();this._worker&&this._worker.terminate();delete this._animating;var b=this.getGeometry();b&&this.ctrl.is_main&&(b.$geo_painter===this?delete b.$geo_painter:b.fVolume&&b.fVolume.$geo_painter===this&&delete b.fVolume.$geo_painter);this._main_painter&&(b=this._main_painter._slave_painters.indexOf(this),0<=b&&this._main_painter._slave_painters.splice(b,
1));for(b=0;b<this._slave_painters.length;++b){var c=this._slave_painters[b];c&&c._main_painter===this&&(c._main_painter=null)}delete this.geo_manager;delete this._highlight_handlers;JSROOT.ObjectPainter.prototype.cleanup.call(this);delete this.ctrl;delete this.options;this.did_cleanup=!0;0>a&&this.selectDom().html("")}if(this._slave_painters)for(var d in this._slave_painters)a=this._slave_painters[d],a._main_painter=null,a._clones===this._clones&&(a._clones=null);this._main_painter=null;this._slave_painters=
[];this._renderer&&(this._renderer.dispose&&this._renderer.dispose(),this._renderer.forceContextLoss&&this._renderer.forceContextLoss());delete this._scene;this._scene_height=this._scene_width=0;this._toplevel=this._renderer=null;delete this._full_geom;delete this._camera;delete this._camera0pos;delete this._lookat;delete this._selected_mesh;this._clones&&this._clones_owner&&this._clones.cleanup(this._draw_nodes,this._build_shapes);delete this._clones;delete this._clones_owner;delete this._draw_nodes;
delete this._drawing_ready;delete this._build_shapes;delete this._new_draw_nodes;delete this._new_append_nodes;delete this._last_camera_position;this.drawing_stage=this.last_render_tm=this.first_render_tm=0;delete this.drawing_log;delete this._datgui;delete this._controls;delete this._context_menu;delete this._tcontrols;delete this._toolbar;delete this._worker};e.prototype.helpText=function(a){r.showProgress(a)};e.prototype.checkResize=function(a){var b=this.getCanvPainter();if(b&&!b.checkCanvasResize(a))return!1;
a=this.getSizeFor3d();if(this._scene_width===a.width&&this._scene_height===a.height||10>a.width||10>a.height)return!1;this._scene_width=a.width;this._scene_height=a.height;this._camera&&this._renderer&&("PerspectiveCamera"==this._camera.type&&(this._camera.aspect=this._scene_width/this._scene_height),this._camera.updateProjectionMatrix(),this._renderer.setSize(this._scene_width,this._scene_height,!this._fit_main_area),this._effectComposer&&this._effectComposer.setSize(this._scene_width,this._scene_height),
this.drawing_stage||this.render3D());return!0};e.prototype.toggleEnlarge=function(){this.enlargeMain("toggle")&&this.checkResize()};e.prototype.ownedByTransformControls=function(a){for(a=a.parent;a&&!(a instanceof f.TransformControls);)a=a.parent;return a&&a instanceof f.TransformControls};e.prototype.accessObjectWireFrame=function(a,b){if(a.hasOwnProperty("material")&&!(a instanceof f.GridHelper)&&!this.ownedByTransformControls(a))return void 0!==b&&a.stack&&(a.material.wireframe=b),a.material.wireframe};
e.prototype.changedWireFrame=function(){var a=this;if(this._scene){var b=this.ctrl.wireframe;this._scene.traverse(function(c){return a.accessObjectWireFrame(c,b)});this.render3D()}};e.prototype.updateObject=function(a){if("same"===a)return!0;if(!a||!a._typename)return!1;if(a===this.getObject())return!0;if(this.geo_manager&&"TGeoManager"==a._typename)return this.geo_manager=a,this.assignObject({_typename:"TGeoNode",fVolume:a.fMasterVolume,fName:a.fMasterVolume.fName,$geoh:a.fMasterVolume.$geoh,_proxy:!0}),
!0;if(!this.matchObjectType(a._typename))return!1;this.assignObject(a);return!0};e.prototype.clearDrawings=function(){this._clones&&this._clones_owner&&this._clones.cleanup(this._draw_nodes,this._build_shapes);delete this._clones;delete this._clones_owner;delete this._draw_nodes;delete this._drawing_ready;delete this._build_shapes;delete this._extraObjects;delete this._clipCfg;r.disposeThreejsObject(this._toplevel,!0);this._full_redrawing=!0};e.prototype.redrawObject=function(a){if(!this.updateObject(a))return!1;
this.clearDrawings();a=this.getGeometry();var b="";this.geo_manager&&(b=a.fName);this.prepareObjectDraw(a,b);return!0};r.createGeoPainter=function(a,b,c){g.GradPerSegm=JSROOT.settings.GeoGradPerSegm;g.CompressComp=JSROOT.settings.GeoCompressComp;a=new e(a,b);a.options=a.decodeOptions(c);JSROOT.extend(a.ctrl,a.options);a.ctrl.ssao.enabled=a.options.usessao;a.ctrl.clip[0].enabled=a.options.clipx;a.ctrl.clip[1].enabled=a.options.clipy;a.ctrl.clip[2].enabled=a.options.clipz;return a};var z=function(a,
b,c){if(!b)return null;var d=null,e=null,h="",f=!1;"fShapeBits"in b&&"fShapeId"in b?(d=b,b=null):"TGeoVolumeAssembly"===b._typename||"TGeoVolume"===b._typename?d=b.fShape:"TEveGeoShapeExtract"===b._typename||"ROOT::Experimental::REveGeoShapeExtract"===b._typename?(d=b.fShape,f=!0):"TGeoManager"===b._typename?d=b.fMasterVolume.fShape:"TGeoOverlap"===b._typename?(e=b.fMarker,h="<prnt>/Marker",b=g.buildOverlapVolume(b),c||(c="wire")):"fVolume"in b?b.fVolume&&(d=b.fVolume.fShape):b=null;"string"==typeof c&&
0==c.indexOf("comp")&&d&&"TGeoCompositeShape"==d._typename&&d.fNode&&(b=1,c=c.substr(4),"x"==c[0]&&(b=999,c=c.substr(1)+"_vislvl999"),b=g.buildCompositeVolume(d,b));!b&&d&&(b=JSROOT.extend(JSROOT.create("TEveGeoShapeExtract"),{fTrans:null,fShape:d,fRGBA:[0,1,0,1],fElements:null,fRnrSelf:!0}));if(!b)return null;var t=r.createGeoPainter(a,b,c);t.ctrl.is_main&&!b.$geo_painter&&(b.$geo_painter=t);!t.ctrl.is_main&&t.ctrl.project&&b.$geo_painter&&(t._main_painter=b.$geo_painter,t._main_painter._slave_painters.push(t));
if(f&&!t.ctrl.vislevel||9>t.ctrl.vislevel)t.ctrl.vislevel=9;e&&(t._splitColors=!0,t.addExtra(e,h));return t.loadMacro(t.ctrl.script_name).then(function(a){return t.prepareObjectDraw(a.obj,a.prefix)})};g.buildCompositeVolume=function(a,b,c){void 0===b&&(b=1);c||(this.$comp_col_cnt=0,c="");var d=JSROOT.create("TGeoVolume");g.SetBit(d,g.BITS.kVisThis,!0);g.SetBit(d,g.BITS.kVisDaughters,!0);if(c&&"TGeoCompositeShape"!==a._typename||0>=b)return d.fName=c,d.fLineColor=this.$comp_col_cnt++%8+2,d.fShape=
a,d;c&&(c+="/");d.$geoh=!0;d.fName="";var e=JSROOT.create("TGeoNodeMatrix");g.SetBit(e,g.BITS.kVisThis,!0);g.SetBit(e,g.BITS.kVisDaughters,!0);e.fName="Left";e.fMatrix=a.fNode.fLeftMat;e.fVolume=g.buildCompositeVolume(a.fNode.fLeft,b-1,c+"Left");var f=JSROOT.create("TGeoNodeMatrix");g.SetBit(f,g.BITS.kVisThis,!0);g.SetBit(f,g.BITS.kVisDaughters,!0);f.fName="Right";f.fMatrix=a.fNode.fRightMat;f.fVolume=g.buildCompositeVolume(a.fNode.fRight,b-1,c+"Right");d.fNodes=JSROOT.create("TList");d.fNodes.Add(e);
d.fNodes.Add(f);c||delete this.$comp_col_cnt;return d};g.buildOverlapVolume=function(a){var b=JSROOT.create("TGeoVolume");g.SetBit(b,g.BITS.kVisDaughters,!0);b.$geoh=!0;b.fName="";var c=JSROOT.create("TGeoNodeMatrix");c.fName=a.fVolume1.fName||"Overlap1";c.fMatrix=a.fMatrix1;c.fVolume=a.fVolume1;var d=JSROOT.create("TGeoNodeMatrix");d.fName=a.fVolume2.fName||"Overlap2";d.fMatrix=a.fMatrix2;d.fVolume=a.fVolume2;b.fNodes=JSROOT.create("TList");b.fNodes.Add(c);b.fNodes.Add(d);return b};g.provideVisStyle=
...
(a._geoobj.$geoh=!0);return Promise.resolve(a._geoobj)}};var d=!1;if("TGeoMaterial"==b._typename)c._icon="img_geomaterial";else if("TGeoMedium"==b._typename)c._icon="img_geomedium";else if("TGeoMixture"==b._typename)c._icon="img_geomixture";else if(0===b._typename.indexOf("TGeoNode")&&b.fVolume){c._title="node:"+b._typename;0<b.fTitle.length&&(c._title+=" "+b.fTitle);var e=b.fVolume}else if(0===b._typename.indexOf("TGeoVolume"))e=b;else if("TEveGeoShapeExtract"==b._typename||"ROOT::Experimental::REveGeoShapeExtract"==
b._typename){d=!0;var f=b.fShape;var m=b.fElements?b.fElements.arr:null}else void 0!==b.fShapeBits&&void 0!==b.fShapeId&&(f=b);e&&(f=e.fShape,m=e.fNodes?e.fNodes.arr:null);if(e||f||m)e&&(c._volume=e),m?(c._more=!0,c._expand=g.expandObject):f&&"TGeoCompositeShape"===f._typename&&f.fNode&&(c._more=!0,c._shape=f,c._expand=function(a){g.createItem(a,a._shape.fNode.fLeft,"Left");g.createItem(a,a._shape.fNode.fRight,"Right");return!0}),c._title||"TGeoVolume"==b._typename||(c._title=b._typename),f?(""==
...
a.fRnrSelf=b.assign:a.fRnrSelf?b.vis++:b.hidden++);if(a.fElements)for(c=0;c<a.fElements.arr.length;++c)d(a.fElements.arr[c],b,!1);return b}function e(a){"self"===a?(m.fRnrSelf=!m.fRnrSelf,b._icon=b._icon.split(" ")[0]+g.provideVisStyle(m),c.updateTreeNode(b)):(d(m,{assign:"true"===a},!0),c.forEachItem(function(a){a._geoobj&&a._icon&&(a._icon=b._icon.split(" ")[0]+g.provideVisStyle(a._geoobj),c.updateTreeNode(a))},b));g.findItemWithPainter(b,"testGeomChanges")}function f(a){g.ToggleBit(p,a);var d=
b._icon.split(" ")[0]+g.provideVisStyle(p);c.forEachItem(function(a){b._volume===a._volume&&(a._icon=d,c.updateTreeNode(a))});c.updateTreeNode(b);g.findItemWithPainter(b,"testGeomChanges")}if(!b._geoobj)return!1;var m=b._geoobj,p=b._volume,q="TEveGeoShapeExtract"===m._typename||"ROOT::Experimental::REveGeoShapeExtract"===m._typename;if(!p&&!q)return!1;a.add("separator");0===b._geoobj._typename.indexOf("TGeoNode")&&g.findItemWithPainter(b)&&a.add("Focus",function(){var a=g.findItemWithPainter(b);if(a){var d=
c.itemFullName(b,a);a._painter&&"function"==typeof a._painter.focusOnItem&&a._painter.focusOnItem(d)}});q?(a.addchk(m.fRnrSelf,"Visible","self",e),q=d(m,void 0,!0),0<q.hidden+q.visible&&a.addchk(0==q.hidden,"Daughters",0!=q.hidden?"true":"false",e)):(a.addchk(g.TestBit(p,g.BITS.kVisNone),"Invisible",g.BITS.kVisNone,f),a.addchk(g.TestBit(p,g.BITS.kVisThis),"Visible",g.BITS.kVisThis,f),a.addchk(g.TestBit(p,g.BITS.kVisDaughters),"Daughters",g.BITS.kVisDaughters,f));return!0};g.findItemWithPainter=function(a,
...
(c+=" geovis_this")}return c};g.expandObject=function(a,b){if(!a||!b)return!1;var c=0===b._typename.indexOf("TGeoNode"),d=0===b._typename.indexOf("TGeoVolume"),e="TGeoManager"===b._typename,f="TEveGeoShapeExtract"===b._typename||"ROOT::Experimental::REveGeoShapeExtract"===b._typename,m="TGeoOverlap"===b._typename;if(!(c||d||e||f||m))return!1;if(a._childs)return!0;if(e)return g.createList(a,b.fMaterials,"Materials","list of materials"),g.createList(a,b.fMedia,"Media","list of media"),g.createList(a,
